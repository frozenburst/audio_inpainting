...
parser.add_argument('--folder_path', default='/your/workspace/datasets/maestro-v3.0.0', type=str,
                    help='The data root')
parser.add_argument('--audio_path', default='/your/workspace/datasets/maestro-v3.0.0/sr48k/audio', type=str,
                    help='The place for audio')
parser.add_argument('--train_path', default='/your/workspace/datasets//maestro-v3.0.0/sr48k/train', type=str,
                    help='The place for training data')
parser.add_argument('--test_path', default='/your/workspace/datasets/maestro-v3.0.0/sr48k/test', type=str,
