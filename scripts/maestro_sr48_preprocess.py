...
parser.add_argument('--folder_path', default='/work/r08922a13/datasets/maestro-v3.0.0', type=str,
                    help='The data root')
parser.add_argument('--audio_path', default='/work/r08922a13/datasets/maestro-v3.0.0/sr48k/audio', type=str,
                    help='The place for audio')
parser.add_argument('--train_path', default='/work/r08922a13/datasets//maestro-v3.0.0/sr48k/train', type=str,
                    help='The place for training data')
parser.add_argument('--test_path', default='/work/r08922a13/datasets/maestro-v3.0.0/sr48k/test', type=str,
                    help='The place for testing data.')


class hp:
    sr = 48000  # Sampling rate. maestro-v3.0.0
    ...
    ref_db = 20.0
    least_amp = 1e-5
    min_length = 5      # spec length 256 ~= 1.6X sec in sr=48000
    max_length = 10
