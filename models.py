...
def inpaint_net(img_height=256, img_width=256, batch_size=32, training=True):
    ...
    #breakpoint()
    #offset_flow = layers.experimental.preprocessing.Resizing(img_height, img_width, 'nearest', name='flow_resize')(offset_flow)
    #offset_flow = resize(offset_flow, img_height, img_width)
